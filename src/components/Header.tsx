...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      >
        <Image src="/Logo.png" alt="Lead Academy - Trading & Investing" width={100} height={66} />
        <div style={{ lineHeight: 1.5 }}>
          <div style={{ fontWeight: 600, fontSize: 20 }}>Lead Academy - Trading & Investing</div>
          <div style={{ fontSize: 16, opacity: 0.75 }}>Versión para escritorio – No compatible con dispositivos móviles</div>
        </div>
      </Link>
